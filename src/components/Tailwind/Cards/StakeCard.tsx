  ...
  return (
    <div>
      <div className="w-auto md:w-44 h-20 md:h-28 grid grid-cols-1 content-between border-2 border-link-alternate rounded-card bg-stakeCard">
        <div className="md:bg-link-alternate font-bold md:font-extrabold tracking-widest uppercase text-md md:text-9px text-link-alternate md:text-white md:text-center pl-3 md:pl-0 py-2 rounded-t-md">
          {title}
        </div>
