...
const polygonTokenList: Token[] = [
  ...
  new Token(ChainId.MATIC, '0x7bcFAF04C9BAD18e3A823740E0683A36426BB0Fe', 18, 'TAUD', 'Wrapped True AUD'),
  new Token(ChainId.MATIC, '0x6d2dCe898dC56B1F26B8053995E7096804cd3fD5', 18, 'TCAD', 'Wrapped True CAD'),
  new Token(ChainId.MATIC, '0xE9958574866587c391735b7e7CE0D79432d3b9d0', 18, 'TGBP', 'Wrapped True GBP'),
