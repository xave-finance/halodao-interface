...
export const HALO: ChainTokenMap = {
  ...
  [ChainId.MATIC_TESTNET]: new Token(
    ...
    process.env.REACT_APP_HALO_TOKEN_ADDRESS_MATIC_MUMBAI_MUMBAI || ZERO_ADDRESS,
    18,
    'RNBW',
    'RNBWToken'
  )
...
export const HALOHALO: ChainTokenMap = {
  ...
  [ChainId.MATIC]: new Token(
    ChainId.MATIC,
    process.env.REACT_APP_HALOHALO_ADDRESS_MATIC_MUMBAI || ZERO_ADDRESS,
    18,
    'wXRNBW',
    'Wrapped xRNBW Token'
  )
...
export const HALO_TOKEN_ADDRESS: ChainAddressMap = {
  ...
  [ChainId.MATIC]: process.env.REACT_APP_HALO_TOKEN_ADDRESS_MATIC_MUMBAI || ZERO_ADDRESS,
  // Testnets
  ...
  [ChainId.MATIC_TESTNET]: process.env.REACT_APP_HALO_TOKEN_ADDRESS_MATIC_MUMBAI_MUMBAI || ZERO_ADDRESS
}
