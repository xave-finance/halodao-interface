import { ChainId, JSBI, Percent, Token, WETH } from '@halodao/sdk'
...
export const HALO: ChainTokenMap = {
  ...
  [ChainId.ARBITRUM]: new Token(
    ChainId.ARBITRUM,
    process.env.REACT_APP_HALO_TOKEN_ADDRESS_ARB || ZERO_ADDRESS,
    18,
    'RNBW',
    'RNBWToken'
  ),
  ...
  [ChainId.ARBITRUM_TESTNET]: new Token(
    ...
    process.env.REACT_APP_HALO_TOKEN_ADDRESS_ARB_RINKEBY || ZERO_ADDRESS,
    18,
    'RNBW',
    'RNBWToken'
  )
...
export const HALO_TOKEN_ADDRESS: ChainAddressMap = {
  ...
  [ChainId.ARBITRUM]: process.env.REACT_APP_HALO_TOKEN_ADDRESS_ARB || ZERO_ADDRESS,
  // Testnets
  ...
  [ChainId.ARBITRUM_TESTNET]: process.env.REACT_APP_HALO_TOKEN_ADDRESS_ARB_RINKEBY || ZERO_ADDRESS
}
...
export const HALO_REWARDS_ADDRESS: ChainAddressMap = {
  ...
  [ChainId.ARBITRUM]: process.env.REACT_APP_HALO_REWARDS_ADDRESS_ARB || ZERO_ADDRESS,
  // Testnets
  ...
  [ChainId.ARBITRUM_TESTNET]: process.env.REACT_APP_HALO_REWARDS_ADDRESS_ARB_RINKEBY || ZERO_ADDRESS
}
...
export const HALO_REWARDS_V1_ADDRESS: ChainAddressMap = {
  ...
  [ChainId.ARBITRUM]: process.env.REACT_APP_HALO_REWARDS_V1_ADDRESS_ARB || ZERO_ADDRESS,
  // Testnets
  ...
  [ChainId.ARBITRUM_TESTNET]: process.env.REACT_APP_HALO_REWARDS_V1_ADDRESS_ARB_RINKEBY || ZERO_ADDRESS
}
...
export const HALO_REWARDS_V1_1_ADDRESS: ChainAddressMap = {
  ...
  [ChainId.ARBITRUM]: process.env.REACT_APP_HALO_REWARDS_V1_1_ADDRESS_ARB || ZERO_ADDRESS,
  // Testnets
  ...
  [ChainId.ARBITRUM_TESTNET]: process.env.REACT_APP_HALO_REWARDS_V1_1_ADDRESS_ARB_RINKEBY || ZERO_ADDRESS
}
...
export const HALO_REWARDS_MANAGER_ADDRESS: ChainAddressMap = {
  ...
  [ChainId.ARBITRUM]: process.env.REACT_APP_HALO_REWARDS_MANAGER_ADDRESS_ARB || ZERO_ADDRESS,
  // Testnets
  ...
  [ChainId.ARBITRUM_TESTNET]: process.env.REACT_APP_HALO_REWARDS_MANAGER_ADDRESS_ARB_RINKEBY || ZERO_ADDRESS
}
...
export const HALOHALO_ADDRESS: ChainAddressMap = {
  ...
  [ChainId.ARBITRUM]: process.env.REACT_APP_HALOHALO_ADDRESS_ARB || ZERO_ADDRESS,
  // Testnets
  ...
  [ChainId.ARBITRUM_TESTNET]: process.env.REACT_APP_HALOHALO_ADDRESS_ARB_RINKEBY || ZERO_ADDRESS
}
...
export const AMM_ZAP_ADDRESS: ChainAddressMap = {
  ...
  [ChainId.ARBITRUM]: process.env.REACT_APP_AMM_ZAP_ADDRESS_ARB || ZERO_ADDRESS,
  // Testnets
  ...
  [ChainId.ARBITRUM_TESTNET]: process.env.REACT_APP_AMM_ZAP_ADDRESS_ARB_RINKEBY || ZERO_ADDRESS
}
...
// Halodao Exchange STUDIO URL
export const HALODAO_EXCHANGE_SUBGRAPH_STUDIO: ChainAddressMap = {
  [ChainId.MAINNET]: process.env.REACT_APP_HALODAO_EXCHANGE_SUBGRAPH_STUDIO_URL_MAINNET,
  [ChainId.MATIC]: process.env.REACT_APP_HALODAO_EXCHANGE_SUBGRAPH_STUDIO_URL_MATIC,
  [ChainId.ARBITRUM]: process.env.REACT_APP_HALODAO_EXCHANGE_SUBGRAPH_STUDIO_URL_ARBITRUM
}

// Halodao Exchange HOSTED URL
export const HALODAO_EXCHANGE_SUBGRAPH_HOSTED: ChainAddressMap = {
  [ChainId.MAINNET]: process.env.REACT_APP_HALODAO_EXCHANGE_SUBGRAPH_HOSTED_URL_MAINNET,
  [ChainId.MATIC]: process.env.REACT_APP_HALODAO_EXCHANGE_SUBGRAPH_HOSTED_URL_MATIC,
  [ChainId.ARBITRUM]: process.env.REACT_APP_HALODAO_EXCHANGE_SUBGRAPH_HOSTED_URL_ARBITRUM
}
