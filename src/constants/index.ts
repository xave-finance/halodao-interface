...
export const HALODAO_EXCHANGE_SUBGRAPH_STUDIO = {
  [ChainId.MAINNET]: process.env.REACT_APP_HALODAO_EXCHANGE_SUBGRAPH_STUDIO_URL
}

// Halodao Exchange HOSTED URL
export const HALODAO_EXCHANGE_SUBGRAPH_HOSTED = {
  [ChainId.MAINNET]: process.env.REACT_APP_HALODAO_EXCHANGE_SUBGRAPH_HOSTED_URL
}
