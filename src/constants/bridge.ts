...
export const BRIDGE_CONTRACTS = {
  ...
  [process.env.REACT_APP_HALO_TOKEN_ADDRESS_MATIC_MUMBAI as string]:
  ...
  [process.env.REACT_APP_HALOHALO_ADDRESS_MATIC_MUMBAI as string]:
...
export const ORIGINAL_TOKEN_CHAIN_ID = {
  ...
  [process.env.REACT_APP_HALO_TOKEN_ADDRESS_MATIC_MUMBAI as string]: ChainId.MAINNET,
  // XRNBW
  [process.env.REACT_APP_HALOHALO_ADDRESS_MAINNET as string]: ChainId.MAINNET,
  [process.env.REACT_APP_HALOHALO_ADDRESS_MATIC_MUMBAI as string]: ChainId.MAINNET,
  // TAUD
