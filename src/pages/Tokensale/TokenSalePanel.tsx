...
import { PAYMENT_AUCTION_ADDRESS } from '../../constants'
...
export default function CurrencyInputPanel({
  ...
  const { commitTokens, allowance, approve } = useMisoDutchAuction()
  const haloBalanceBigInt = useTokenBalance(chainId ? PAYMENT_AUCTION_ADDRESS[chainId] : undefined || '')
